...
router.post('/login',[helper.hasAuthFileds, helper.isPasswordAndUserMatch], (req,res)=>{
...
//register router
router.post('/register',[check('email').isEmail().not().isEmpty().withMessage('Field can\'t  be empty')
